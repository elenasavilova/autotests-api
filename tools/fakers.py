...
class Fake:
    ...
    def __init__(self, faker: Faker):
        """
        Конструктор класса принимает один параметр — экземпляр класса Faker. Это даёт нам гибкость для работы с
        различными языками или провайдерами данных, просто передав другой экземпляр Faker с нужной настройкой.
    ...
    def integer(self, start: int=1, end: int=100) -> str:
        """
    ...
    def max_score(self) -> int:
        """
        Генерирует случайный максимальный балл в диапазоне от 30 до 100.
        :return: Случайный балл.
        """
        return self.faker.random_int(30, 100)
